...
\chapter{LUCRARI ANTERIOARE}
  ...
  Inceputul inteligentei aritificiale a fost.. perceptron, CNN iar in final s-a ajuns la modelele mari de limbaj \ac{llm}.
  Modelele mari de limbaj sunt urmatorul pas dupa \ac{lstm} si \ac{rnn} care functionau pe baza.

  \section{Maturizarea modelelor mari de limbaj si cercetari actuale(\ac{llm})}

  % Optimizari recente, si arhitecturi
